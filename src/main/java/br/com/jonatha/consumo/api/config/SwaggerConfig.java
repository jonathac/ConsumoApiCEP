package br.com.jonatha.consumo.api.config;
...
public class SwaggerConfig implements WebMvcConfigurer{
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
                ...
                .apis(RequestHandlerSelectors.basePackage("br.com.jonatha.consumo.api.resources"))
                .paths(PathSelectors.any()).build().apiInfo(apiInfo());
    }

    private ApiInfo apiInfo() {
        return new ApiInfo("Consumo de API de cep",
                "Esta API é consumo de API externa", "Versão 1.0", null,
